...
SYCL_EXTERNAL void procesarAristaVer_2s_2step(TVec3 *W0, TVec3 *W1, double H0, double H1, sycl::double2 *d_acumulador_1,
              sycl::double2 *d_acumulador_2, int pos_vol0, int pos_vol1, double CFL, double cosPhi0, double longitud,
              double delta_T, double area0, double area1, double cvis, TVec2 *Fmas2s, TVec2 *Fmenos2s);

SYCL_EXTERNAL void procesarAristaVer_2s_waf_2step(TVec3 *W0m, TVec3 *W0, TVec3 *W1, TVec3 *W1p, double H0m,
...
SYCL_EXTERNAL void procesarAristasVerNivel0Paso2GPU( sycl::nd_item<2> idx,
              sycl::double2 *d_datosVolumenes_1, sycl::double2 *d_datosVolumenes_2,
              sycl::double2 *d_datosVolumenes_3, double *d_altoVolumenes, int num_volx, int num_voly, double borde1,
              double borde2, double delta_T, sycl::double2 *d_acumulador_1, sycl::double2 *d_acumulador_2,
              double CFL, double epsilon_h, double hpos, double cvis, int tipo);
...
SYCL_EXTERNAL void procesarAristaHor_2s_2step(TVec3 *W0, TVec3 *W1, double H0, double H1, double longitud,
...
SYCL_EXTERNAL void procesarAristaHor_2s_waf_2step(TVec3 *W0m, TVec3 *W0, TVec3 *W1, TVec3 *W1p, double H0m,
              double H0, double H1, double H1p, double normal, double longitud, double area0, double area1,
              double delta_T, sycl::double2 *d_acumulador_1, sycl::double2 *d_acumulador_2, int pos_vol0, int pos_vol1,
...
// DELTA_T INICIAL
SYCL_EXTERNAL void procesarAristaDeltaTInicial(TVec3 *W0, TVec3 *W1, double H0, double H1, double normal1_x, double normal1_y,
              double longitud, sycl::double2 *d_acumulador_2, int pos_vol0, int pos_vol1, double epsilon_h, double cosPhi0);
...
SYCL_EXTERNAL void procesarAristasVerDeltaTInicialNivel0GPU( sycl::nd_item<2> idx,
              ...
              double *d_altoVolumenesNivel0, sycl::double2 *d_acumulador_1, double epsilon_h, int tipo);
